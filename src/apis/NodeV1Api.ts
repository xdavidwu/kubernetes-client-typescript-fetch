...
export class NodeV1Api extends runtime.BaseAPI {
     ...
     */
    async createRuntimeClassRaw(requestParameters: NodeV1ApiCreateRuntimeClassRequest): Promise<runtime.ApiResponse<V1RuntimeClass>> {
     ...
     * create a RuntimeClass
     */
    async createRuntimeClass(requestParameters: NodeV1ApiCreateRuntimeClassRequest): Promise<V1RuntimeClass> {
     ...
     */
    async deleteCollectionRuntimeClassRaw(requestParameters: NodeV1ApiDeleteCollectionRuntimeClassRequest): Promise<runtime.ApiResponse<V1Status>> {
        const queryParameters: any = {};
     ...
     * delete collection of RuntimeClass
     */
    async deleteCollectionRuntimeClass(requestParameters: NodeV1ApiDeleteCollectionRuntimeClassRequest): Promise<V1Status> {
     ...
     */
    async deleteRuntimeClassRaw(requestParameters: NodeV1ApiDeleteRuntimeClassRequest): Promise<runtime.ApiResponse<V1Status>> {
     ...
     * delete a RuntimeClass
     */
    async deleteRuntimeClass(requestParameters: NodeV1ApiDeleteRuntimeClassRequest): Promise<V1Status> {
     ...
     */
    async listRuntimeClassRaw(requestParameters: NodeV1ApiListRuntimeClassRequest): Promise<runtime.ApiResponse<V1RuntimeClassList>> {
        const queryParameters: any = {};
     ...
     * list or watch objects of kind RuntimeClass
     */
    async listRuntimeClass(requestParameters: NodeV1ApiListRuntimeClassRequest): Promise<V1RuntimeClassList> {
     ...
     */
    async patchRuntimeClassRaw(requestParameters: NodeV1ApiPatchRuntimeClassRequest): Promise<runtime.ApiResponse<V1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified RuntimeClass
     */
    async patchRuntimeClass(requestParameters: NodeV1ApiPatchRuntimeClassRequest): Promise<V1RuntimeClass> {
     ...
     */
    async readRuntimeClassRaw(requestParameters: NodeV1ApiReadRuntimeClassRequest): Promise<runtime.ApiResponse<V1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified RuntimeClass
     */
    async readRuntimeClass(requestParameters: NodeV1ApiReadRuntimeClassRequest): Promise<V1RuntimeClass> {
     ...
     */
    async replaceRuntimeClassRaw(requestParameters: NodeV1ApiReplaceRuntimeClassRequest): Promise<runtime.ApiResponse<V1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified RuntimeClass
     */
    async replaceRuntimeClass(requestParameters: NodeV1ApiReplaceRuntimeClassRequest): Promise<V1RuntimeClass> {
