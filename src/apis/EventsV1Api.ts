...
export class EventsV1Api extends runtime.BaseAPI {
     ...
     * create an Event
     */
    async createNamespacedEventRaw(requestParameters: EventsV1ApiCreateNamespacedEventRequest): Promise<runtime.ApiResponse<EventsV1Event>> {
     ...
     * create an Event
     */
    async createNamespacedEvent(requestParameters: EventsV1ApiCreateNamespacedEventRequest): Promise<EventsV1Event> {
     ...
     */
    async deleteCollectionNamespacedEventRaw(requestParameters: EventsV1ApiDeleteCollectionNamespacedEventRequest): Promise<runtime.ApiResponse<V1Status>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * delete collection of Event
     */
    async deleteCollectionNamespacedEvent(requestParameters: EventsV1ApiDeleteCollectionNamespacedEventRequest): Promise<V1Status> {
     ...
     * delete an Event
     */
    async deleteNamespacedEventRaw(requestParameters: EventsV1ApiDeleteNamespacedEventRequest): Promise<runtime.ApiResponse<V1Status>> {
     ...
     * delete an Event
     */
    async deleteNamespacedEvent(requestParameters: EventsV1ApiDeleteNamespacedEventRequest): Promise<V1Status> {
     ...
     */
    async listEventForAllNamespacesRaw(requestParameters: EventsV1ApiListEventForAllNamespacesRequest): Promise<runtime.ApiResponse<EventsV1EventList>> {
        const queryParameters: any = {};
     ...
     * list or watch objects of kind Event
     */
    async listEventForAllNamespaces(requestParameters: EventsV1ApiListEventForAllNamespacesRequest): Promise<EventsV1EventList> {
     ...
     * list or watch objects of kind Event
     */
    async listNamespacedEventRaw(requestParameters: EventsV1ApiListNamespacedEventRequest): Promise<runtime.ApiResponse<EventsV1EventList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * list or watch objects of kind Event
     */
    async listNamespacedEvent(requestParameters: EventsV1ApiListNamespacedEventRequest): Promise<EventsV1EventList> {
     ...
     */
    async patchNamespacedEventRaw(requestParameters: EventsV1ApiPatchNamespacedEventRequest): Promise<runtime.ApiResponse<EventsV1Event>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified Event
     */
    async patchNamespacedEvent(requestParameters: EventsV1ApiPatchNamespacedEventRequest): Promise<EventsV1Event> {
     ...
     */
    async readNamespacedEventRaw(requestParameters: EventsV1ApiReadNamespacedEventRequest): Promise<runtime.ApiResponse<EventsV1Event>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified Event
     */
    async readNamespacedEvent(requestParameters: EventsV1ApiReadNamespacedEventRequest): Promise<EventsV1Event> {
     ...
     */
    async replaceNamespacedEventRaw(requestParameters: EventsV1ApiReplaceNamespacedEventRequest): Promise<runtime.ApiResponse<EventsV1Event>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified Event
     */
    async replaceNamespacedEvent(requestParameters: EventsV1ApiReplaceNamespacedEventRequest): Promise<EventsV1Event> {
