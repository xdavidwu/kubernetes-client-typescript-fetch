...
export class CoordinationV1Api extends runtime.BaseAPI {
     ...
     * create a Lease
     */
    async createNamespacedLeaseRaw(requestParameters: CoordinationV1ApiCreateNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
     ...
     * create a Lease
     */
    async createNamespacedLease(requestParameters: CoordinationV1ApiCreateNamespacedLeaseRequest): Promise<V1Lease> {
     ...
     */
    async deleteCollectionNamespacedLeaseRaw(requestParameters: CoordinationV1ApiDeleteCollectionNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Status>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * delete collection of Lease
     */
    async deleteCollectionNamespacedLease(requestParameters: CoordinationV1ApiDeleteCollectionNamespacedLeaseRequest): Promise<V1Status> {
     ...
     * delete a Lease
     */
    async deleteNamespacedLeaseRaw(requestParameters: CoordinationV1ApiDeleteNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Status>> {
     ...
     * delete a Lease
     */
    async deleteNamespacedLease(requestParameters: CoordinationV1ApiDeleteNamespacedLeaseRequest): Promise<V1Status> {
     ...
     */
    async listLeaseForAllNamespacesRaw(requestParameters: CoordinationV1ApiListLeaseForAllNamespacesRequest): Promise<runtime.ApiResponse<V1LeaseList>> {
        const queryParameters: any = {};
     ...
     * list or watch objects of kind Lease
     */
    async listLeaseForAllNamespaces(requestParameters: CoordinationV1ApiListLeaseForAllNamespacesRequest): Promise<V1LeaseList> {
     ...
     * list or watch objects of kind Lease
     */
    async listNamespacedLeaseRaw(requestParameters: CoordinationV1ApiListNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1LeaseList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * list or watch objects of kind Lease
     */
    async listNamespacedLease(requestParameters: CoordinationV1ApiListNamespacedLeaseRequest): Promise<V1LeaseList> {
     ...
     */
    async patchNamespacedLeaseRaw(requestParameters: CoordinationV1ApiPatchNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified Lease
     */
    async patchNamespacedLease(requestParameters: CoordinationV1ApiPatchNamespacedLeaseRequest): Promise<V1Lease> {
     ...
     */
    async readNamespacedLeaseRaw(requestParameters: CoordinationV1ApiReadNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified Lease
     */
    async readNamespacedLease(requestParameters: CoordinationV1ApiReadNamespacedLeaseRequest): Promise<V1Lease> {
     ...
     */
    async replaceNamespacedLeaseRaw(requestParameters: CoordinationV1ApiReplaceNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified Lease
     */
    async replaceNamespacedLease(requestParameters: CoordinationV1ApiReplaceNamespacedLeaseRequest): Promise<V1Lease> {
