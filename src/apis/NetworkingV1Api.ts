...
export class NetworkingV1Api extends runtime.BaseAPI {
     ...
     */
    async patchNamespacedNetworkPolicyStatusRaw(requestParameters: NetworkingV1ApiPatchNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1NetworkPolicy>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update status of the specified NetworkPolicy
     */
    async patchNamespacedNetworkPolicyStatus(requestParameters: NetworkingV1ApiPatchNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1NetworkPolicy> {
        const response = await this.patchNamespacedNetworkPolicyStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async readNamespacedNetworkPolicyStatusRaw(requestParameters: NetworkingV1ApiReadNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1NetworkPolicy>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read status of the specified NetworkPolicy
     */
    async readNamespacedNetworkPolicyStatus(requestParameters: NetworkingV1ApiReadNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1NetworkPolicy> {
        const response = await this.readNamespacedNetworkPolicyStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async replaceNamespacedNetworkPolicyStatusRaw(requestParameters: NetworkingV1ApiReplaceNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1NetworkPolicy>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace status of the specified NetworkPolicy
     */
    async replaceNamespacedNetworkPolicyStatus(requestParameters: NetworkingV1ApiReplaceNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1NetworkPolicy> {
        const response = await this.replaceNamespacedNetworkPolicyStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
