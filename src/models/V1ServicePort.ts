...
/**
 * Check if a given object implements the V1ServicePort interface.
 */
export function instanceOfV1ServicePort(value: object): value is V1ServicePort {
...
export function V1ServicePortFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ServicePort {
    ...
    return {
        ...
        'targetPort': json['targetPort'] == null ? undefined : IntOrStringFromJSON(json['targetPort']),
    };
}
