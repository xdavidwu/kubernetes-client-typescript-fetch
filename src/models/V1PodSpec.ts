 ...
 */
export function instanceOfV1PodSpec(value: object): boolean {
    let isInstance = true;
...
export function V1PodSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1PodSpec {
    ...
    return {
        ...
        'resourceClaims': !exists(json, 'resourceClaims') ? undefined : ((json['resourceClaims'] as Array<any>).map(V1PodResourceClaimFromJSON)),
        ...
        'schedulingGates': !exists(json, 'schedulingGates') ? undefined : ((json['schedulingGates'] as Array<any>).map(V1PodSchedulingGateFromJSON)),
...
export function V1PodSpecToJSON(value?: V1PodSpec | null): any {
    ...
    return {
        ...
        'resourceClaims': value.resourceClaims === undefined ? undefined : ((value.resourceClaims as Array<any>).map(V1PodResourceClaimToJSON)),
        'restartPolicy': value.restartPolicy,
        'runtimeClassName': value.runtimeClassName,
        'schedulerName': value.schedulerName,
        'schedulingGates': value.schedulingGates === undefined ? undefined : ((value.schedulingGates as Array<any>).map(V1PodSchedulingGateToJSON)),
