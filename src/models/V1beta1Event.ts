...
import type { V1beta1EventSeries } from './V1beta1EventSeries';
import {
...
/**
 * Check if a given object implements the V1beta1Event interface.
 */
export function instanceOfV1beta1Event(value: object): boolean {
    let isInstance = true;
