...
/**
 * Check if a given object implements the V1ControllerRevision interface.
 */
export function instanceOfV1ControllerRevision(value: object): value is V1ControllerRevision {
