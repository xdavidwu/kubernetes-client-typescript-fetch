...
import type { StorageV1TokenRequest } from './StorageV1TokenRequest';
import {
...
/**
 * Check if a given object implements the V1CSIDriverSpec interface.
 */
export function instanceOfV1CSIDriverSpec(value: object): value is V1CSIDriverSpec {
    return true;
}
...
export function V1CSIDriverSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1CSIDriverSpec {
    ...
    return {
        ...
        'tokenRequests': json['tokenRequests'] == null ? undefined : ((json['tokenRequests'] as Array<any>).map(StorageV1TokenRequestFromJSON)),
...
export function V1CSIDriverSpecToJSON(value?: V1CSIDriverSpec | null): any {
    ...
    return {
        ...
        'tokenRequests': value['tokenRequests'] == null ? undefined : ((value['tokenRequests'] as Array<any>).map(StorageV1TokenRequestToJSON)),
