...
import type { ApiregistrationV1ServiceReference } from './ApiregistrationV1ServiceReference';
import {
...
/**
 * Check if a given object implements the V1APIServiceSpec interface.
 */
export function instanceOfV1APIServiceSpec(value: object): value is V1APIServiceSpec {
...
export function V1APIServiceSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1APIServiceSpec {
    ...
    return {
        ...
        'service': json['service'] == null ? undefined : ApiregistrationV1ServiceReferenceFromJSON(json['service']),
