 ...
 */
export function instanceOfV1beta3LimitedPriorityLevelConfiguration(value: object): boolean {
    let isInstance = true;
...
export function V1beta3LimitedPriorityLevelConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta3LimitedPriorityLevelConfiguration {
    ...
    return {
        ...
        'limitResponse': !exists(json, 'limitResponse') ? undefined : V1beta3LimitResponseFromJSON(json['limitResponse']),
