 ...
 */
export function instanceOfV1ReplicaSet(value: object): value is V1ReplicaSet {
    return true;
}
...
export function V1ReplicaSetFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ReplicaSet {
    ...
    return {
        ...
        'spec': json['spec'] == null ? undefined : V1ReplicaSetSpecFromJSON(json['spec']),
        'status': json['status'] == null ? undefined : V1ReplicaSetStatusFromJSON(json['status']),
    };
}
