...
export function V1ValidatingWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ValidatingWebhook {
    ...
    return {
        ...
        'matchConditions': !exists(json, 'matchConditions') ? undefined : ((json['matchConditions'] as Array<any>).map(V1MatchConditionFromJSON)),
...
export function V1ValidatingWebhookToJSON(value?: V1ValidatingWebhook | null): any {
    ...
    return {
        ...
        'matchConditions': value.matchConditions === undefined ? undefined : ((value.matchConditions as Array<any>).map(V1MatchConditionToJSON)),
