 ...
 */
export function instanceOfV1beta1ValidatingAdmissionPolicyList(value: object): value is V1beta1ValidatingAdmissionPolicyList {
    return true;
}
...
export function V1beta1ValidatingAdmissionPolicyListFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1ValidatingAdmissionPolicyList {
    ...
    return {
        ...
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(V1beta1ValidatingAdmissionPolicyFromJSON)),
...
export function V1beta1ValidatingAdmissionPolicyListToJSON(value?: V1beta1ValidatingAdmissionPolicyList | null): any {
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(V1beta1ValidatingAdmissionPolicyToJSON)),
        'kind': value['kind'],
