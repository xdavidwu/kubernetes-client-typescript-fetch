...
import type { V1SessionAffinityConfig } from './V1SessionAffinityConfig';
import {
...
/**
 * Check if a given object implements the V1ServiceSpec interface.
 */
export function instanceOfV1ServiceSpec(value: object): value is V1ServiceSpec {
    return true;
}
...
export function V1ServiceSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ServiceSpec {
    ...
    return {
        ...
        'ports': json['ports'] == null ? undefined : ((json['ports'] as Array<any>).map(V1ServicePortFromJSON)),
        ...
        'sessionAffinityConfig': json['sessionAffinityConfig'] == null ? undefined : V1SessionAffinityConfigFromJSON(json['sessionAffinityConfig']),
...
export function V1ServiceSpecToJSON(value?: V1ServiceSpec | null): any {
    ...
    return {
        ...
        'ports': value['ports'] == null ? undefined : ((value['ports'] as Array<any>).map(V1ServicePortToJSON)),
