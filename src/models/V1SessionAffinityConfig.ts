 ...
 */
export function instanceOfV1SessionAffinityConfig(value: object): value is V1SessionAffinityConfig {
    return true;
}
...
export function V1SessionAffinityConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1SessionAffinityConfig {
    ...
    return {
        ...
        'clientIP': json['clientIP'] == null ? undefined : V1ClientIPConfigFromJSON(json['clientIP']),
    };
}
