 ...
 */
export function instanceOfV1CustomResourceDefinitionStatus(value: object): value is V1CustomResourceDefinitionStatus {
    return true;
}
...
export function V1CustomResourceDefinitionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1CustomResourceDefinitionStatus {
    ...
    return {
        ...
        'acceptedNames': json['acceptedNames'] == null ? undefined : V1CustomResourceDefinitionNamesFromJSON(json['acceptedNames']),
        'conditions': json['conditions'] == null ? undefined : ((json['conditions'] as Array<any>).map(V1CustomResourceDefinitionConditionFromJSON)),
...
export function V1CustomResourceDefinitionStatusToJSON(value?: V1CustomResourceDefinitionStatus | null): any {
    ...
    return {
        ...
        'conditions': value['conditions'] == null ? undefined : ((value['conditions'] as Array<any>).map(V1CustomResourceDefinitionConditionToJSON)),
