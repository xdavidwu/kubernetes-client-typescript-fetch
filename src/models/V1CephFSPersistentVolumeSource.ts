...
/**
 * Check if a given object implements the V1CephFSPersistentVolumeSource interface.
 */
export function instanceOfV1CephFSPersistentVolumeSource(value: object): value is V1CephFSPersistentVolumeSource {
