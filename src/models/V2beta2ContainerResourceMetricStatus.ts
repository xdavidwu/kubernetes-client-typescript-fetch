...
/**
 * Check if a given object implements the V2beta2ContainerResourceMetricStatus interface.
 */
export function instanceOfV2beta2ContainerResourceMetricStatus(value: object): boolean {
    let isInstance = true;
