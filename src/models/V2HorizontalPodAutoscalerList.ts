...
/**
 * Check if a given object implements the V2HorizontalPodAutoscalerList interface.
 */
export function instanceOfV2HorizontalPodAutoscalerList(value: object): value is V2HorizontalPodAutoscalerList {
