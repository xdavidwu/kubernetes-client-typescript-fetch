 ...
 */
export function instanceOfV1ServiceAccount(value: object): value is V1ServiceAccount {
    return true;
}
...
export function V1ServiceAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ServiceAccount {
    ...
    return {
        ...
        'secrets': json['secrets'] == null ? undefined : ((json['secrets'] as Array<any>).map(V1ObjectReferenceFromJSON)),
    };
}
...
export function V1ServiceAccountToJSON(value?: V1ServiceAccount | null): any {
    ...
    return {
        ...
        'secrets': value['secrets'] == null ? undefined : ((value['secrets'] as Array<any>).map(V1ObjectReferenceToJSON)),
    };
}
