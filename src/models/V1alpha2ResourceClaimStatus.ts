 ...
 */
export function instanceOfV1alpha2ResourceClaimStatus(value: object): boolean {
    let isInstance = true;
...
export function V1alpha2ResourceClaimStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha2ResourceClaimStatus {
    ...
    return {
        ...
        'allocation': !exists(json, 'allocation') ? undefined : V1alpha2AllocationResultFromJSON(json['allocation']),
        ...
        'reservedFor': !exists(json, 'reservedFor') ? undefined : ((json['reservedFor'] as Array<any>).map(V1alpha2ResourceClaimConsumerReferenceFromJSON)),
    };
}
...
export function V1alpha2ResourceClaimStatusToJSON(value?: V1alpha2ResourceClaimStatus | null): any {
    ...
    return {
        ...
        'reservedFor': value.reservedFor === undefined ? undefined : ((value.reservedFor as Array<any>).map(V1alpha2ResourceClaimConsumerReferenceToJSON)),
    };
}
