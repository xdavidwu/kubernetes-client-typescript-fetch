 ...
 */
export function instanceOfV1AggregationRule(value: object): value is V1AggregationRule {
    return true;
}
...
export function V1AggregationRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1AggregationRule {
    ...
    return {
        ...
        'clusterRoleSelectors': json['clusterRoleSelectors'] == null ? undefined : ((json['clusterRoleSelectors'] as Array<any>).map(V1LabelSelectorFromJSON)),
    };
}
...
export function V1AggregationRuleToJSON(value?: V1AggregationRule | null): any {
    ...
    return {
        ...
        'clusterRoleSelectors': value['clusterRoleSelectors'] == null ? undefined : ((value['clusterRoleSelectors'] as Array<any>).map(V1LabelSelectorToJSON)),
    };
}
