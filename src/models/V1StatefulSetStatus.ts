 ...
 */
export function instanceOfV1StatefulSetStatus(value: object): value is V1StatefulSetStatus {
...
export function V1StatefulSetStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1StatefulSetStatus {
    ...
    return {
        ...
        'conditions': json['conditions'] == null ? undefined : ((json['conditions'] as Array<any>).map(V1StatefulSetConditionFromJSON)),
...
export function V1StatefulSetStatusToJSON(value?: V1StatefulSetStatus | null): any {
    ...
    return {
        ...
        'conditions': value['conditions'] == null ? undefined : ((value['conditions'] as Array<any>).map(V1StatefulSetConditionToJSON)),
