...
/**
 * Check if a given object implements the V1beta1PodDisruptionBudgetStatus interface.
 */
export function instanceOfV1beta1PodDisruptionBudgetStatus(value: object): boolean {
    let isInstance = true;
