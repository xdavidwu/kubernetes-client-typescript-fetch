...
/**
 * Check if a given object implements the V2beta1ContainerResourceMetricSource interface.
 */
export function instanceOfV2beta1ContainerResourceMetricSource(value: object): boolean {
    let isInstance = true;
