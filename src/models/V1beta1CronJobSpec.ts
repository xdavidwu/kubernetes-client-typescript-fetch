...
import type { V1beta1JobTemplateSpec } from './V1beta1JobTemplateSpec';
import {
...
/**
 * Check if a given object implements the V1beta1CronJobSpec interface.
 */
export function instanceOfV1beta1CronJobSpec(value: object): boolean {
    let isInstance = true;
