...
/**
 * Check if a given object implements the V1beta2Subject interface.
 */
export function instanceOfV1beta2Subject(value: object): boolean {
    let isInstance = true;
