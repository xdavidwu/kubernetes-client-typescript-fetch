 ...
 */
export function instanceOfV1beta1ValidatingAdmissionPolicyStatus(value: object): boolean {
    let isInstance = true;
...
export function V1beta1ValidatingAdmissionPolicyStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1ValidatingAdmissionPolicyStatus {
    ...
    return {
        ...
        'typeChecking': !exists(json, 'typeChecking') ? undefined : V1beta1TypeCheckingFromJSON(json['typeChecking']),
    };
}
