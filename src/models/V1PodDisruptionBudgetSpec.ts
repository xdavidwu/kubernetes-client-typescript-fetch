 ...
 */
export function instanceOfV1PodDisruptionBudgetSpec(value: object): value is V1PodDisruptionBudgetSpec {
    return true;
}
...
export function V1PodDisruptionBudgetSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1PodDisruptionBudgetSpec {
    ...
    return {
        ...
        'minAvailable': json['minAvailable'] == null ? undefined : IntOrStringFromJSON(json['minAvailable']),
