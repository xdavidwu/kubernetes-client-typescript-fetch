...
import type { V1beta1RuntimeClass } from './V1beta1RuntimeClass';
import {
...
/**
 * Check if a given object implements the V1beta1RuntimeClassList interface.
 */
export function instanceOfV1beta1RuntimeClassList(value: object): boolean {
    let isInstance = true;
