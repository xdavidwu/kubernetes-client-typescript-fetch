 ...
 */
export function instanceOfV1alpha1MatchResources(value: object): value is V1alpha1MatchResources {
    return true;
}
...
export function V1alpha1MatchResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha1MatchResources {
    ...
    return {
        ...
        'excludeResourceRules': json['excludeResourceRules'] == null ? undefined : ((json['excludeResourceRules'] as Array<any>).map(V1alpha1NamedRuleWithOperationsFromJSON)),
        ...
        'resourceRules': json['resourceRules'] == null ? undefined : ((json['resourceRules'] as Array<any>).map(V1alpha1NamedRuleWithOperationsFromJSON)),
    };
}
...
export function V1alpha1MatchResourcesToJSON(value?: V1alpha1MatchResources | null): any {
    ...
    return {
        ...
        'excludeResourceRules': value['excludeResourceRules'] == null ? undefined : ((value['excludeResourceRules'] as Array<any>).map(V1alpha1NamedRuleWithOperationsToJSON)),
        ...
        'resourceRules': value['resourceRules'] == null ? undefined : ((value['resourceRules'] as Array<any>).map(V1alpha1NamedRuleWithOperationsToJSON)),
    };
}
