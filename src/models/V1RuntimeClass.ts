...
import type { V1Overhead } from './V1Overhead';
import {
    V1OverheadFromJSON,
    V1OverheadFromJSONTyped,
    V1OverheadToJSON,
} from './V1Overhead';
import type { V1Scheduling } from './V1Scheduling';
import {
...
/**
 * Check if a given object implements the V1RuntimeClass interface.
 */
export function instanceOfV1RuntimeClass(value: object): value is V1RuntimeClass {
...
export function V1RuntimeClassFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1RuntimeClass {
    ...
    return {
        ...
        'overhead': json['overhead'] == null ? undefined : V1OverheadFromJSON(json['overhead']),
        'scheduling': json['scheduling'] == null ? undefined : V1SchedulingFromJSON(json['scheduling']),
    };
}
