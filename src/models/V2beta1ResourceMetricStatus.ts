...
/**
 * Check if a given object implements the V2beta1ResourceMetricStatus interface.
 */
export function instanceOfV2beta1ResourceMetricStatus(value: object): boolean {
    let isInstance = true;
