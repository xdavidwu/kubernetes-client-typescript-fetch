 ...
 */
export function instanceOfV1alpha2ResourceClaimSpec(value: object): boolean {
    let isInstance = true;
...
export function V1alpha2ResourceClaimSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha2ResourceClaimSpec {
    ...
    return {
        ...
        'parametersRef': !exists(json, 'parametersRef') ? undefined : V1alpha2ResourceClaimParametersReferenceFromJSON(json['parametersRef']),
