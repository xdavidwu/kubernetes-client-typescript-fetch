...
/**
 * Check if a given object implements the V1ValidationRule interface.
 */
export function instanceOfV1ValidationRule(value: object): value is V1ValidationRule {
    if (!('rule' in value) || value['rule'] === undefined) return false;
    return true;
}

export function V1ValidationRuleFromJSON(json: any): V1ValidationRule {
    return V1ValidationRuleFromJSONTyped(json, false);
}

export function V1ValidationRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ValidationRule {
    if (json == null) {
        return json;
    }
    return {
...
export function V1ValidationRuleToJSON(value?: V1ValidationRule | null): any {
    if (value == null) {
        return value;
    }
    return {
