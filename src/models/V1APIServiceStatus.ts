 ...
 */
export function instanceOfV1APIServiceStatus(value: object): value is V1APIServiceStatus {
    return true;
}
...
export function V1APIServiceStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1APIServiceStatus {
    ...
    return {
        ...
        'conditions': json['conditions'] == null ? undefined : ((json['conditions'] as Array<any>).map(V1APIServiceConditionFromJSON)),
    };
}
...
export function V1APIServiceStatusToJSON(value?: V1APIServiceStatus | null): any {
    ...
    return {
        ...
        'conditions': value['conditions'] == null ? undefined : ((value['conditions'] as Array<any>).map(V1APIServiceConditionToJSON)),
    };
}
