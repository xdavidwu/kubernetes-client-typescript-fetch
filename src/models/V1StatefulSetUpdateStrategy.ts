 ...
 */
export function instanceOfV1StatefulSetUpdateStrategy(value: object): value is V1StatefulSetUpdateStrategy {
    return true;
}
...
export function V1StatefulSetUpdateStrategyFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1StatefulSetUpdateStrategy {
    ...
    return {
        ...
        'rollingUpdate': json['rollingUpdate'] == null ? undefined : V1RollingUpdateStatefulSetStrategyFromJSON(json['rollingUpdate']),
