...
/**
 * Check if a given object implements the V1RuleWithOperations interface.
 */
export function instanceOfV1RuleWithOperations(value: object): value is V1RuleWithOperations {
    return true;
}
