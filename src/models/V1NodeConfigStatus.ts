 ...
 */
export function instanceOfV1NodeConfigStatus(value: object): value is V1NodeConfigStatus {
    return true;
}
...
export function V1NodeConfigStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1NodeConfigStatus {
    ...
    return {
        ...
        'active': json['active'] == null ? undefined : V1NodeConfigSourceFromJSON(json['active']),
        'assigned': json['assigned'] == null ? undefined : V1NodeConfigSourceFromJSON(json['assigned']),
        'error': json['error'] == null ? undefined : json['error'],
        'lastKnownGood': json['lastKnownGood'] == null ? undefined : V1NodeConfigSourceFromJSON(json['lastKnownGood']),
    };
}
