 ...
 */
export function instanceOfV1VolumeNodeAffinity(value: object): value is V1VolumeNodeAffinity {
    return true;
}
...
export function V1VolumeNodeAffinityFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1VolumeNodeAffinity {
    ...
    return {
        ...
        'required': json['required'] == null ? undefined : V1NodeSelectorFromJSON(json['required']),
    };
}
