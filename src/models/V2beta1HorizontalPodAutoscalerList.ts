...
import type { V2beta1HorizontalPodAutoscaler } from './V2beta1HorizontalPodAutoscaler';
import {
...
/**
 * Check if a given object implements the V2beta1HorizontalPodAutoscalerList interface.
 */
export function instanceOfV2beta1HorizontalPodAutoscalerList(value: object): boolean {
    let isInstance = true;
