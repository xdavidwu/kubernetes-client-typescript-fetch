...
import type { V1beta1PriorityLevelConfiguration } from './V1beta1PriorityLevelConfiguration';
import {
...
/**
 * Check if a given object implements the V1beta1PriorityLevelConfigurationList interface.
 */
export function instanceOfV1beta1PriorityLevelConfigurationList(value: object): boolean {
    let isInstance = true;
