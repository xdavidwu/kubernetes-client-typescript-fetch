...
/**
 * Check if a given object implements the V1beta1PriorityLevelConfigurationReference interface.
 */
export function instanceOfV1beta1PriorityLevelConfigurationReference(value: object): boolean {
    let isInstance = true;
