...
/**
 * Check if a given object implements the V1PodDisruptionBudgetStatus interface.
 */
export function instanceOfV1PodDisruptionBudgetStatus(value: object): value is V1PodDisruptionBudgetStatus {
    if (!('currentHealthy' in value) || value['currentHealthy'] === undefined) return false;
    if (!('desiredHealthy' in value) || value['desiredHealthy'] === undefined) return false;
    if (!('disruptionsAllowed' in value) || value['disruptionsAllowed'] === undefined) return false;
    if (!('expectedPods' in value) || value['expectedPods'] === undefined) return false;
    return true;
}
