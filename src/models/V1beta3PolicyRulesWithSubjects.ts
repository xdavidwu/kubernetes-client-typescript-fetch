 ...
 */
export function instanceOfV1beta3PolicyRulesWithSubjects(value: object): value is V1beta3PolicyRulesWithSubjects {
...
export function V1beta3PolicyRulesWithSubjectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta3PolicyRulesWithSubjects {
    ...
    return {
        ...
        'nonResourceRules': json['nonResourceRules'] == null ? undefined : ((json['nonResourceRules'] as Array<any>).map(V1beta3NonResourcePolicyRuleFromJSON)),
        'resourceRules': json['resourceRules'] == null ? undefined : ((json['resourceRules'] as Array<any>).map(V1beta3ResourcePolicyRuleFromJSON)),
...
export function V1beta3PolicyRulesWithSubjectsToJSON(value?: V1beta3PolicyRulesWithSubjects | null): any {
    ...
    return {
        ...
        'nonResourceRules': value['nonResourceRules'] == null ? undefined : ((value['nonResourceRules'] as Array<any>).map(V1beta3NonResourcePolicyRuleToJSON)),
        'resourceRules': value['resourceRules'] == null ? undefined : ((value['resourceRules'] as Array<any>).map(V1beta3ResourcePolicyRuleToJSON)),
